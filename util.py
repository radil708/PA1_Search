...
class FixedRandom:
    def __init__(self):
        # Seems to be a list. First element is 3, second element is a list of numbers, last element is None
        ...
        # the setstate() method will restore the state of  the random number generator back to this sate.
